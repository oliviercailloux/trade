...
\begin{itemize}
  ...
  \item Profit is $π(φ) = B_a φ^{σ - 1} - f_d$ with $B_a = \frac{L}{P_a^{1 - σ}} \frac{(σ - 1)^{σ - 1}}{σ^{σ - 1} σ} = \frac{A}{σ}$
  \item Profit is $π(φ) 
  = p_φ q_φ - \frac{q_φ}{φ} - f_d
  = \frac{L}{P^{1 - σ}} \frac{1}{p_φ^{σ - 1}} - \frac{L}{P^{1 - σ}} \frac{1}{φ p_φ^σ} - f_d
  = \frac{L}{P^{1 - σ}} (\frac{1}{p_φ^{σ - 1}} - \frac{1}{φ p_φ^σ}) - f_d
  = \frac{L}{P^{1 - σ}} ((\frac{σ - 1}{σ})^{σ - 1} φ^{σ - 1} - (\frac{σ - 1}{σ})^σ φ^{σ - 1}) - f_d
  = \frac{L}{P^{1 - σ}} (\frac{σ - 1}{σ})^{σ - 1} φ^{σ - 1} (1 - (\frac{σ - 1}{σ})) - f_d
  ...
  % = \frac{L}{P^{1 - σ}} \frac{1}{p_φ^{σ - 1}} - \frac{L}{P^{1 - σ}} \frac{1}{φ p_φ^σ} - f_d 
  % = \frac{L}{P^{1 - σ}} (\frac{1}{p_φ^{σ - 1}} - \frac{1}{φ p_φ^σ}) - f_d
  % = \frac{L}{P^{1 - σ}} \frac{1}{p_φ^{σ - 1}} (1 - \frac{1}{φ p_φ}) - f_d$
  % \item Profit is $π(φ) = r(φ) - \frac{q_φ}{φ} - f_d = \frac{r(φ)}{σ} - f_d$
  \item Zero Cutoff (ZCP?) is the level $φ_a$ such that $π(φ_a) = 0$
  ...
  \item Aggregate productivity is $\bar{φ}(φ_a) = (\int_{Φ^*} φ^{σ - 1} dμ^*)^\frac{1}{σ - 1}$
  \item Let $M_e$ be the mass of drawers (potential entrants), then the mass of producers (entered) is $M_a = M_e (1 - G(φ_a))$
  ...
  \item Obtain $f_e = f_d J(φ_a)$ with $J(φ_a) = \int_{Φ^*} \left((\frac{φ}{φ_a})^{σ - 1} - 1\right) dμ$
  \item Expected profit conditional to entering is $\bar{π}(φ_a) = \int_{Φ^*} π(φ) dμ^* = \frac{f_e}{μ(Φ^*)}$
\end{itemize}
%\bibliography{bibl}
