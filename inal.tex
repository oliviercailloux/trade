...
\begin{itemize}
  \item Iceberg type trading cost: domestic varieties have price $p^X = τ p^D$ abroad, with $τ > 1$, $p^D = \frac{σ}{σ - 1} \frac{w}{φ}$
  \item Total production is $q = q^D + τ q^X$, with $q^X$ the quantity that effectively arrives abroad
  \item Thus we sell $q$ at $p^D$, equivalently, $q^D$ at $p^D$ domestically and $q^X$ at $p^X$ abroad
  \item Total profit is $π = p^D q - w (f + \frac{q}{φ}) = \frac{1}{σ - 1} \frac{wq}{φ} - wf$
  \item From $π = 0$ we obtain $q = φ f (σ - 1)$ as above; same as in autarky
  \item Using $L = nf + n\frac{q}{φ}$, we obtain $n = \frac{L}{σ f}$; same as in autarky
  \item From above, $q^X = \left(\frac{p^X}{P^X}\right)^{-σ} \frac{w^X L^X}{P^X}$, thus $q^X = \left(\frac{τ p^D}{P^X}\right)^{-σ} \frac{w^X L^X}{P^X}$
  \item It follows that the value $X = τ p^D q^X n$ of aggregate exports (the gravity equation) depend linearly on $L^D L^P$ and on $τ^{1 - σ}$.
\end{itemize}
Mechanisms through which trade increases:
\begin{description}
  \item[$τ$ finite] Trade increases through extensive margins: countries start exchanging every varieties (why?)
  \item[$τ$ reduces] Trade increases through intensive margins: higher export in quantity but constant number of varieties
\end{description}
Effect of trade:
\begin{itemize}
  \item ${P^D}^{(1)} = [n^D {p^D}^{1 - σ} + n^X {(τ p^D)}^{1 - σ}]^\frac{1}{1 - σ}$
  \item With $τ = 1$ and $n^X = n^D$, we get ${P^D}^{(1)} = \frac{{P^D}^{(0)}}{2^\frac{1}{σ - 1}}$: price index decreases
