...
\begin{itemize}
  ...
  \item Productivity $γ: Ω → (0, ∞)$ is a positive random variable on $Ω$ associated with probability $P$ (thus with $P(∅) = 0$ and $P(Ω) = P(γ ∈ (0, ∞)) = 1$), CDF defined as $G(φ) = P(γ ≤ φ)$ (thus $G(0) = 0$), assumed differentiable, and PDF defined as $g(φ) = G'(φ)$ (thus $G(a) = \int_0^a g(φ) dφ$)
\end{itemize}
